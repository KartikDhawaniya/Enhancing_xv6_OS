...
void getmeminfo(int pid)
{
  ...
  // cprintf("Size of virtual memory: %d\n", p->sz/PGSIZE);
  // cprintf("Size of physical memory: %d\n", count);

  cprintf("Number of page tables pages: %d\n", ps);
}
